class BeerClubsController < ApplicationController
  ...
  before_action :ensure_that_has_admin_rights, only: [:destroy]
  # GET /beer_clubs
  # GET /beer_clubs.json
  def index
  ...
  def show
    if not current_user.nil? and Membership.find_by user_id:current_user.id, beer_club_id:@beer_club.id
